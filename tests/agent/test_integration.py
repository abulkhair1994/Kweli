...
class TestAgentTools:
    ...
    def test_get_graph_schema_tool(self, neo4j_available):
        ...
        from kweli.agent.tools import get_graph_schema
    ...
    def test_execute_cypher_tool(self, neo4j_available):
        ...
        from kweli.agent.tools import execute_cypher_query
    ...
    def test_top_countries_tool(self, neo4j_available):
        ...
        from kweli.agent.tools import get_top_countries_by_learners
